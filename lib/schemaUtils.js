...
module.exports = {
  ...
  */
   ...
   * @param {*} options - the current set of options from outside
   ...
   * @no-unit-test
   */
  getAuthHelper: function(openapi, securitySet, options) {
    var securityDef,
      helper;
    ...
    securitySet.forEach((security) => {
      ...
      if (!_.isObject(securityDef)) {
        ...
        if (options.accessToken) {
          helper.oauth2 = [
            { key: 'accessToken', value: options.accessToken, type: 'string' },
            { key: 'addTokenTo',
  ...
  * @param {object} schemaCache - object storing schemaFaker and schmeResolution caches
   ...
   * @param {*} components components defined in OAS spec
   * @param {*} options current options from outside
  ...
  * @param {object} schemaCache - object storing schemaFaker and schmeResolution caches
  ...
  convertToPmQueryParameters: function(param, requestType, components, options, schemaCache) {
    ...
    if (param.hasOwnProperty('schema')) {
      ...
      // there might be an example value
      if (param.hasOwnProperty('example')) {
      ...
      return this.convertParamsWithStyle(param, paramValue, PARAMETER_SOURCE.REQUEST, components, options, schemaCache);
    }
   ...
   */
  convertParamsWithStyle: function(param, paramValue, parameterSource, components, options, schemaCache) {
        ...
        if (explode && _.isObject(paramValue)) {
          _.forEach(paramValue, (value, key) => {
            pmParams.push({
              ...
              disabled: !param.required && options.disableQueryParams,
              description
            });
          });
          return pmParams;
  ...
  * @param {object} schemaCache - object storing schemaFaker and schmeResolution caches
  ...
  convertToPmHeader: function(header, requestType, parameterSource, components, options, schemaCache) {
    ...
    if (header.hasOwnProperty('schema')) {
      ...
      // If they've given us an example value, use that
      if (header.hasOwnProperty('example')) {
        fakeData = header.example;
      }
      else if (!options.schemaFaker) {
        fakeData = '';
      }
      else {
  ...
  * @param {object} schemaCache - object storing schemaFaker and schmeResolution caches
   ...
   * @param {*} components - Components from OAS spec
   * @param {*} options - Current options from outside
  ...
  */
  convertRequestToItem: function(openapi, operationItem, components, options, schemaCache, variableStore) {
    ...
    authHelper = this.getAuthHelper(openapi, operation.security, options);
    ...
    if (operation.responses) {
      ...
      if (options.includeAuthInfoInExample) {
        ...
        if (_.isEmpty(authHelper)) {
          responseAuthHelper = this.getResponseAuthHelper(this.getAuthHelper(openapi, openapi.security, options));
        }
