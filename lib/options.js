...
module.exports = {
  ...
  getOptions: function(mode = 'document', criteria = {}) {
    ...
    let optsArray = [
      ...
      {
        name: 'Disable Header Params',
        id: 'disableHeaderParams',
        type: 'boolean',
        default: false,
        description: 'Are header parameters disabled in the resultant collection?',
        external: true,
        usage: ['CONVERSION']
      },
      {
        name: 'Disable Query Params',
        id: 'disableQueryParams',
        type: 'boolean',
        default: false,
        description: 'Are query parameter fields disabled in the resultant collection?',
        external: true,
        usage: ['CONVERSION']
      },
      {
        ...
        id: 'accessToken',
        type: 'string',
        description: 'What is the default OAuth2.0 Access Token for all operations in the resultant collection?',
        external: true,
        usage: ['CONVERSION']
      },
      {
